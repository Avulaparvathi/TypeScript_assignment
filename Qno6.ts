import { T_shirt } from './quesno6';

const t: T_shirt={color:'black',material:'cotton',design:'v neck',size:'s'};

const t1: T_shirt={color:'black',material:'cotton',design:'v neck',size:'M'};

const t2: T_shirt={color:'black',material:'cotton',design:'v neck',size:'XL'};
