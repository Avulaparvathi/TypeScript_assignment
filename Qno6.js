...
var t = { color: 'black', material: 'cotton', design: 'v neck', size: 's' };
var t1 = { color: 'black', material: 'cotton', design: 'v neck', size: 'M' };
var t2 = { color: 'black', material: 'cotton', design: 'v neck', size: 'XL' };
